...
(function () {
    ...
    ///定义文件标识符
    window.util3e6299dbd6d04e238eb64ae42c423b96 = "util.js";
    ...
    String.prototype.isUrlOrIPv4 = function () { return this.isUrl() || this.isIP(); };
    ...
    String.prototype.toDate = function () {
        var i = this.indexOf("."), str = this.replace(/-/g, "\/").replaceAll("T", " ");
    ...
    Array.prototype.contains = function (item, compare) {
        ...
        for (var i = 0; i < this.length; i++) {
            var b = (item == this[i]);
            if (b || (window.isFunction(compare) && compare.call(this, item, this[i]) == true)) {
                result = true; break;
            }
        }
        return result;
    ...
    ///过滤复制
    Array.prototype.ruleCopy = function (item, compare) {
        var temps = new Array();
        for (var i = 0; i < this.length; i++) {
            var b = item == this[i];
            if (!(b || (window.isFunction(compare) && compare.call(this, item, this[i]) == true))) { temps.push(this[i]); }
        }
        return temps;
    };
    ...
    ////////////////////////////////////////////////
    Array.attach = function (array, item, compare) {
        if (!Array.isArray(array)) { return; }
        if (!array.contains(item, compare)) { array.push(item); }
    };
    Array.prototype.attach = function (item, compare) { Array.attach(this, item, compare); };
