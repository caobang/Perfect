...
(function ($) {
    ...
    */
    function Calendar(y, m) {
        ...
        //公历节日
        for (var i in sFtv) {
            if (typeof sFtv[i] == "string" && sFtv[i].match(/^(\d{2})(\d{2})([\s\*])(.+)$/)) {
        ...
        //月周节日
        for (var i in wFtv) {
            if (typeof wFtv[i] == "string" && wFtv[i].match(/^(\d{2})(\d)(\d)([\s\*])(.+)$/)) {
                if (Number(RegExp.$1) == (m + 1)) {
        ...
        //农历节日
        for (var i in lFtv) {
            if (typeof lFtv[i] == "string" && lFtv[i].match(/^(\d{2})(.{2})([\s\*])(.+)$/)) {
                ...
                day.hover(function (e) {
                    ...
                    if (inf) {
                        var ct = '<font color="#ffffff" style="font-size:9pt;">' + inf.sYear
							 ...
							 + '<br><font color="violet">农历 ' + monthName[inf.lMonth - 1] + ' ' + cDay(inf.lDay, inf.lMonth, true)
